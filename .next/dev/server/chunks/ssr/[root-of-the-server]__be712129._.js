...
function AdminLoginPage() {
    ...
    const handleSubmit = async (e)=>{
        ...
        setLoading(true);
        try {
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$client$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__["authAPI"].login({
                email,
                password
            });
            if (res && res.success) {
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$client$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__["authAPI"].logout();
            } else {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__be712129._.js.map