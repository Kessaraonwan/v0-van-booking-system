...
function RoutesManagement() {
    ...
    const [editingRoute, setEditingRoute] = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react__$5b$external$5d$__$28$react$2c$__cjs$29$__["useState"])(null);
    const [formOrigin, setFormOrigin] = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react__$5b$external$5d$__$28$react$2c$__cjs$29$__["useState"])('');
    const [formDestination, setFormDestination] = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react__$5b$external$5d$__$28$react$2c$__cjs$29$__["useState"])('');
    const [formPrice, setFormPrice] = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react__$5b$external$5d$__$28$react$2c$__cjs$29$__["useState"])('');
    const [formDuration, setFormDuration] = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react__$5b$external$5d$__$28$react$2c$__cjs$29$__["useState"])('');
    const [formDistance, setFormDistance] = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react__$5b$external$5d$__$28$react$2c$__cjs$29$__["useState"])('');
    const [formImage, setFormImage] = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react__$5b$external$5d$__$28$react$2c$__cjs$29$__["useState"])('');
    const [formIsPopular, setFormIsPopular] = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react__$5b$external$5d$__$28$react$2c$__cjs$29$__["useState"])(false);
    ...
    const handleSaveRoute = async ()=>{
        ...
        try {
            ...
            if (editingRoute && editingRoute.id) {
                response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$client$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__["adminAPI"].updateRoute(editingRoute.id, payload);
            } else {
                response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$client$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__["adminAPI"].createRoute(payload);
            }
    ...
    const handleDeleteRoute = async (routeId)=>{
        ...
        try {
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$client$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__["adminAPI"].deleteRoute(routeId);
            if (res && res.success) {
                await fetchRoutes();
            }
        } catch (err) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1822efc2._.js.map