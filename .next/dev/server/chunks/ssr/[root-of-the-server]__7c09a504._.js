...
function RegisterPage() {
    ...
    const handleSubmit = async (e)=>{
        ...
        setErrors({});
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$client$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__["default"].register(formData.email, formData.password, formData.name);
            if (response.success) {
                toast({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__7c09a504._.js.map